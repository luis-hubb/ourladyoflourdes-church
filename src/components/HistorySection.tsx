...
const HistorySection = () => {
  ...
  const additionalHistory = [
    ...
    "Since there was lack of place in the church, the parish church was again renovated in the year 2019 by then parish priest fr. Nicholas D’Souza, OFM. From May 2021 onwards, Fr. Premkumar Dsouza OFM is serving as the parish priest of the parish and Dr. Dharma Bernard OFM is serving as assisting priest. The parish has around 197 families and around 660 Catholics parishioners.The Church has its own cemetery behind the Church building on the hill slope, which has also a history of over 90 years. ",
    "St. Joseph chapel:",
